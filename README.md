...
[![Validate Markdown](https://github.com/hexsecs/awesome-embedded-security/workflows/Validate%20Markdown/badge.svg)](https://github.com/hexsecs/awesome-embedded-security/actions/workflows/markdown-lint.yml) ⭐ 60 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-31
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,333 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images.
* [UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,666 | 🐛 23 | 🌐 C | 📅 2026-07-29 - Viewer and editor for UEFI firmware images, able to parse the volume structure and extract or replace individual modules.
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,561 | 🐛 30 | 🌐 C++ | 📅 2026-09-06 - Library to Instrument Executable Formats: parse, modify, and abstract ELF, PE, Mach-O, DEX, and OAT binaries found in firmware images.
* [FLARE-FLOSS](https://github.com/mandiant/flare-floss) ⭐ 4,147 | 🐛 116 | 🌐 Python | 📅 2026-09-11 - FLARE Obfuscated String Solver that automatically extracts obfuscated, encoded, and stack strings from binaries for rapid firmware triage.
* [unblob](https://github.com/onekey-sec/unblob) ⭐ 2,554 | 🐛 41 | 🌐 Python | 📅 2026-09-08 - Fast, accurate firmware extraction engine from ONEKEY supporting 100+ archive, compression, and filesystem formats with fewer false positives than Binwalk. Presented at DEF CON 30.
...
* [ubi\_reader](https://github.com/onekey-sec/ubi_reader) ⭐ 642 | 🐛 11 | 🌐 Python | 📅 2026-09-04 - Extracts UBI and UBIFS images, the raw-NAND filesystem format that generic carvers handle poorly.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,086 | 🐛 741 | 🌐 Python | 📅 2026-09-12 - Platform-agnostic binary analysis framework. Brought to you by the Computer Security Lab at UC Santa Barbara, SEFCOM at Arizona State University, their associated CTF team, Shellphish, the open source community, and @rhelmot.
* [Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,011 | 🐛 358 | 🌐 C | 📅 2026-09-10 - Lightweight multi-platform, multi-architecture disassembly framework. Their target is to make Capstone the ultimate disassembly engine for binary analysis and reversing in the security community.
* [RetDec](https://github.com/avast/retdec) ⭐ 8,628 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - Retargetable machine-code decompiler from Avast supporting ARM, MIPS, x86, and other architectures common in embedded firmware.
...
* [BinDiff](https://github.com/google/bindiff) ⭐ 3,178 | 🐛 51 | 🌐 Java | 📅 2026-09-09 - Google's binary diffing engine for comparing two versions of a binary, matching functions across them to locate patched vulnerabilities and port symbols.
...
* [Angr Management](https://github.com/angr/angr-management) ⭐ 1,181 | 🐛 248 | 🌐 Python | 📅 2026-09-12 - Multi-architecture binary analysis toolkit, with the capability to perform dynamic symbolic execution (like Mayhem, KLEE, etc.) and various static analyses on binaries. If you'd like to learn how to use it, you're in the right place!
...
* [Open OCD](https://github.com/openocd-org/openocd/) ⭐ 2,319 | 🐛 3 | 🌐 C | 📅 2026-09-12 - Provides on-chip programming and debugging support with a layered architecture of JTAG interface and TAP support.
...
* [MCUboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,104 | 🐛 96 | 🌐 C | 📅 2026-09-11 - Secure bootloader for 32-bit microcontrollers supporting signed images, rollback protection, and measured boot flows.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,875 | 🐛 409 | 🌐 Go | 📅 2026-09-11 - Vulnerability scanner that consumes SBOMs to identify known CVEs in firmware dependencies.
* [Syft](https://github.com/anchore/syft) ⭐ 9,553 | 🐛 645 | 🌐 Go | 📅 2026-09-11 - SBOM generator for filesystems and artifacts, useful for firmware package/component inventories.
* [Sigstore Cosign](https://github.com/sigstore/cosign) ⭐ 6,296 | 🐛 166 | 🌐 Go | 📅 2026-09-08 - Tooling for keyless signing and verification of firmware/container artifacts in CI/CD pipelines.
* [CVE Binary Tool](https://github.com/ossf/cve-bin-tool) ⭐ 1,759 | 🐛 237 | 🌐 Python | 📅 2026-09-07 - OpenSSF tool that scans binaries directly for 350+ known-vulnerable open source components (OpenSSL, libpng, BusyBox, and more), without requiring a pre-built SBOM; can also generate one from the scan.
...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,749 | 🐛 23 | 🌐 C | 📅 2026-09-04 - A coverage-guided fuzzer with enhanced mutations, QEMU and Unicorn emulation modes, and custom power schedules.
...
* Java
  * [JADX](https://github.com/skylot/jadx) ⭐ 50,436 | 🐛 447 | 🌐 Java | 📅 2026-09-08 - Dex to Java decompiler.
  * [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,201 | 🐛 248 | 🌐 Java | 📅 2024-07-08 - Java decompiler.
* .NET
  * [ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,058 | 🐛 171 | 🌐 C# | 📅 2026-09-12 - .NET Decompiler with support for PDB generation, ReadyToRun, Metadata (\&more) - cross-platform!
  * [dnSpy](https://github.com/dnSpyEx/dnSpy) ⭐ 11,058 | 🐛 146 | 🌐 C# | 📅 2026-08-25 - .NET debugger and assembly editor.
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,991 | 🐛 606 | 🌐 Ruby | 📅 2026-09-11 - Open source penetration testing framework (BSD licensed) maintained by Rapid7, with modules for exploiting vulnerabilities, scanning, and post-exploitation across embedded Linux and IoT targets.
* [kernel-hardening-checker](https://github.com/a13xp0p0v/kernel-hardening-checker) ⭐ 2,131 | 🐛 12 | 🌐 Python | 📅 2026-09-09 - Audits Linux kernel Kconfig options and boot parameters against KSPP, CLIP OS, and STIG hardening recommendations; supports ARM, ARM64, x86, and RISC-V. Works in Yocto/OpenEmbedded pipelines.
* [IoTGoat](https://github.com/OWASP/IoTGoat) ⭐ 930 | 🐛 2 | 🌐 C | 📅 2025-10-05 - OWASP intentionally insecure firmware for Raspberry Pi and x86 platforms, providing hands-on practice for the OWASP IoT Top 10 vulnerabilities.
...
* [RT-Thread Security](https://github.com/RT-Thread/rt-thread/security) ⭐ 12,213 | 🐛 495 | 🌐 C | 📅 2026-09-11 - Security resources and vulnerability reporting for RT-Thread IoT OS.
...
* [GATTacker](https://github.com/securing/gattacker) ⭐ 848 | 🐛 18 | 🌐 JavaScript | 📅 2022-01-31 - BLE MITM tool for intercepting and relaying GATT profiles to test BLE device authentication and data integrity.
* [InternalBlue](https://github.com/seemoo-lab/internalblue) ⭐ 788 | 🐛 21 | 🌐 Python | 📅 2024-08-21 - Bluetooth experimentation framework enabling binary patching, LMP injection, and live monitoring of Broadcom/Cypress firmware on commodity devices (iPhone, Samsung Galaxy, Raspberry Pi) without custom hardware.
...
* [SweynTooth](https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks) ⭐ 335 | 🐛 15 | 🌐 Python | 📅 2021-11-23 - Runnable PoC exploits for 18 BLE link-layer and L2CAP vulnerabilities across TI, NXP, Cypress, Dialog, Microchip, and STMicro SDKs, including full pairing bypass and link-layer overflows. USENIX ATC 2020.
...
* [Rayhunter](https://github.com/EFForg/rayhunter) ⭐ 5,806 | 🐛 98 | 🌐 Rust | 📅 2026-09-10 - EFF's open source Rust tool that runs on a cheap mobile hotspot to detect cell-site simulators (IMSI catchers/Stingrays) by monitoring signaling traffic for suspicious behavior like forced 2G downgrades.
* [Open5GS](https://github.com/open5gs/open5gs) ⭐ 2,712 | 🐛 296 | 🌐 C | 📅 2026-09-12 - Open-source 5G core and 4G EPC, used to stand up a controlled network for baseband and cellular protocol testing.
...
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 882 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - Full-system emulation platform for Samsung (Shannon) and MediaTek cellular baseband firmware with AFL++ fuzzing integration, a task-injection ModKit, and dynamic debugging support. Found 7 pre-authentication memory corruptions. NDSS 2022.
...
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,657 | 🐛 13 | 🌐 Shell | 📅 2026-09-11 - Efficient malware analysis framework for embedded firmware with scanning and reporting.
* [Firmware Analysis Toolkit](https://github.com/attify/firmware-analysis-toolkit) ⭐ 1,597 | 🐛 51 | 🌐 Rust | 📅 2026-09-08 - Automated tool for firmware emulation and vulnerability discovery.
...
* [Unicorn Engine](https://github.com/unicorn-engine/unicorn) ⭐ 9,323 | 🐛 215 | 🌐 C | 📅 2026-08-28 - A lightweight multi-architecture CPU emulator framework providing pure CPU emulation for ARM, MIPS, x86, RISC-V, and more.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,096 | 🐛 110 | 🌐 Python | 📅 2026-09-07 - An advanced binary emulation framework supporting cross-platform OS-level emulation for Windows, Linux, Android, BSD, UEFI, and multiple architectures.
...
* [FirmAE](https://github.com/pr0v3rbs/FirmAE) ⭐ 928 | 🐛 49 | 🌐 Python | 📅 2026-06-24 - An automated framework for emulation and vulnerability analysis of IoT firmware with an 79% success rate using arbitration techniques.
...
* [CHIPSEC](https://github.com/chipsec/chipsec) ⭐ 3,298 | 🐛 49 | 🌐 Python | 📅 2026-09-12 - Platform security assessment framework with firmware and chipset checks relevant to offline dump triage.
...
* [PicoGlitcher](https://github.com/MKesenheimer/fault-injection-library) ⭐ 208 | 🐛 8 | 🌐 Python | 📅 2026-07-29 - RP2040/RP2350-based voltage glitching platform with 66A crowbar, sub-10ns pulse resolution via PIO sampling, and a high-level Python (`findus`) API for scripting attack campaigns. Validated by SySS Research.
...
* [MFCUK](https://github.com/nfc-tools/mfcuk) ⭐ 1,114 | 🐛 40 | 🌐 C | 📅 2024-07-10 - Implementation of the Dark Side attack, recovering a first MIFARE Classic key when none is known.

### RF Tools (Non-SDR)

* [rtl\_433](https://github.com/merbanan/rtl_433) ⭐ 7,800 | 🐛 89 | 🌐 C | 📅 2026-09-10 - Decoder for over 250 ISM-band device protocols covering sensors, utility meters, TPMS, and remotes, built on cheap RTL-SDR hardware.
* [Proxmark3](https://github.com/RfidResearchGroup/proxmark3) ⭐ 6,048 | 🐛 50 | 🌐 C | 📅 2026-09-12 - Open-source RFID research platform for low-level interaction, analysis, and testing across a wide range of LF and HF tags and systems.
* [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) ⭐ 3,001 | 🐛 111 | 🌐 C | 📅 2026-09-11 - Pocket friendly powerful LF and HF emulation & manipulation tool which is based on the open-source project ChameleonMini.
...
* [ESP32 Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,323 | 🐛 328 | 🌐 C++ | 📅 2026-09-12 - A suite of WiFi/Bluetooth offensive and defensive tools for the ESP32.
...
* Domain Specific
  * Automotive
    * [CANbus](https://github.com/iDoka/awesome-canbus) ⭐ 3,462 | 🐛 6 | 📅 2026-08-07 - CAN bus tooling, adapters, protocol documentation, and reverse engineering resources.
...
* Embedded
  * [General Embedded](https://github.com/nhivp/Awesome-Embedded) ⭐ 9,106 | 🐛 4 | 📅 2026-09-06 - Embedded development resources: RTOSes, toolchains, libraries, and hardware platforms.
  * [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security) ⭐ 2,442 | 🐛 2 | 📅 2023-10-17 - Firmware analysis, emulation, and IoT security research, maintained by Fraunhofer FKIE.
* General Security
  * [OSINT](https://github.com/jivoi/awesome-osint) ⭐ 29,348 | 🐛 8 | 📅 2026-09-09 - Open source intelligence tooling for reconnaissance across people, infrastructure, and internet-exposed devices.
  * [Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,047 | 🐛 73 | 📅 2024-06-02 - Broad collection of offensive security tools, courses, and reference material.
  * [Security](https://github.com/sbilly/awesome-security) ⭐ 14,850 | 🐛 328 | 📅 2026-01-11 - General-purpose security resources spanning network, host, web, and cryptography.
  * [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,189 | 🐛 25 | 📅 2024-06-07 - Static and dynamic malware analysis tools, sandboxes, and sample sources.
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,844 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 - CTF frameworks, practice platforms, wargames, and write-up archives.
  * [Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,553 | 🐛 25 | 🌐 Python | 📅 2026-06-01 - Deception tooling and honeynets spanning network, application, and industrial protocols.
  * [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,683 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - Android reverse engineering, exploitation, and mobile application security tooling.
  * [Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,379 | 🐛 81 | 📅 2026-07-15 - Digital forensics and incident response tooling, playbooks, and training material.
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,054 | 🐛 41 | 🌐 PHP | 📅 2025-02-22 - Secure development practices, code analysis, and application security testing.
...
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,329 | 🐛 106 | 📅 2026-09-02 - The root Awesome list, indexing curated lists across every topic.
  * [lists](https://github.com/jnv/lists) ⭐ 11,476 | 🐛 27 | 📅 2026-03-23 - Index of curated lists of lists, broader in scope than Awesome itself.
