...
[![Validate Markdown](https://github.com/hexsecs/awesome-embedded-security/workflows/Validate%20Markdown/badge.svg)](https://github.com/hexsecs/awesome-embedded-security/actions/workflows/markdown-lint.yml) ⭐ 61 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-14
...
* [UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,675 | 🐛 23 | 🌐 C | 📅 2026-07-29 - Viewer and editor for UEFI firmware images, able to parse the volume structure and extract or replace individual modules.
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,565 | 🐛 30 | 🌐 C++ | 📅 2026-09-06 - Library to Instrument Executable Formats: parse, modify, and abstract ELF, PE, Mach-O, DEX, and OAT binaries found in firmware images.
...
* [unblob](https://github.com/onekey-sec/unblob) ⭐ 2,555 | 🐛 39 | 🌐 Python | 📅 2026-09-15 - Fast, accurate firmware extraction engine from ONEKEY supporting 100+ archive, compression, and filesystem formats with fewer false positives than Binwalk. Presented at DEF CON 30.
* [checksec](https://github.com/slimm609/checksec) ⭐ 2,380 | 🐛 3 | 🌐 Go | 📅 2026-09-10 - Go tool reporting binary hardening flags (NX, PIE, RELRO, stack canary, FORTIFY\_SOURCE) on ELF executables extracted from firmware, with JSON and XML output and kernel config auditing; rewritten from the original shell script.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,089 | 🐛 732 | 🌐 Python | 📅 2026-09-15 - Platform-agnostic binary analysis framework. Brought to you by the Computer Security Lab at UC Santa Barbara, SEFCOM at Arizona State University, their associated CTF team, Shellphish, the open source community, and @rhelmot.
* [Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,023 | 🐛 358 | 🌐 C | 📅 2026-09-15 - Lightweight multi-platform, multi-architecture disassembly framework. Their target is to make Capstone the ultimate disassembly engine for binary analysis and reversing in the security community.
...
* [Triton](https://github.com/JonathanSalwan/Triton) ⭐ 4,295 | 🐛 39 | 🌐 C++ | 📅 2026-09-12 - Dynamic binary analysis library providing symbolic execution, taint tracking, and an SMT solver interface for x86, ARM, AArch64, and RISC-V.
* [Miasm](https://github.com/cea-sec/miasm) ⭐ 3,960 | 🐛 184 | 🌐 Python | 📅 2026-08-24 - Reverse engineering framework with its own intermediate language, a JIT emulator, and symbolic execution, covering MSP430 and MIPS alongside the usual architectures.
* [BinDiff](https://github.com/google/bindiff) ⭐ 3,180 | 🐛 52 | 🌐 Java | 📅 2026-09-09 - Google's binary diffing engine for comparing two versions of a binary, matching functions across them to locate patched vulnerabilities and port symbols.
...
* [Angr Management](https://github.com/angr/angr-management) ⭐ 1,181 | 🐛 247 | 🌐 Python | 📅 2026-09-15 - Multi-architecture binary analysis toolkit, with the capability to perform dynamic symbolic execution (like Mayhem, KLEE, etc.) and various static analyses on binaries. If you'd like to learn how to use it, you're in the right place!
* [Vivisect](https://github.com/vivisect/vivisect) ⭐ 1,000 | 🐛 121 | 🌐 Python | 📅 2026-09-14 - A combined disassembler/static analysis/symbolic execution/debugger framework.
...
* [Open OCD](https://github.com/openocd-org/openocd/) ⭐ 2,325 | 🐛 3 | 🌐 C | 📅 2026-09-14 - Provides on-chip programming and debugging support with a layered architecture of JTAG interface and TAP support.
...
* [MCUboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,112 | 🐛 95 | 🌐 C | 📅 2026-09-15 - Secure bootloader for 32-bit microcontrollers supporting signed images, rollback protection, and measured boot flows.
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 534 | 🐛 14 | 🌐 C | 📅 2026-09-14 - Portable secure bootloader for 32-bit MCUs using wolfCrypt for image signature verification (Ed25519, ECC, RSA, post-quantum LMS/XMSS), with delta updates, encrypted images, and explicit voltage-glitch countermeasures.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,886 | 🐛 405 | 🌐 Go | 📅 2026-09-14 - Vulnerability scanner that consumes SBOMs to identify known CVEs in firmware dependencies.
* [Syft](https://github.com/anchore/syft) ⭐ 9,564 | 🐛 647 | 🌐 Go | 📅 2026-09-15 - SBOM generator for filesystems and artifacts, useful for firmware package/component inventories.
* [Sigstore Cosign](https://github.com/sigstore/cosign) ⭐ 6,304 | 🐛 162 | 🌐 Go | 📅 2026-09-14 - Tooling for keyless signing and verification of firmware/container artifacts in CI/CD pipelines.
* [CVE Binary Tool](https://github.com/ossf/cve-bin-tool) ⭐ 1,763 | 🐛 237 | 🌐 Python | 📅 2026-09-14 - OpenSSF tool that scans binaries directly for 350+ known-vulnerable open source components (OpenSSL, libpng, BusyBox, and more), without requiring a pre-built SBOM; can also generate one from the scan.
...
* [boofuzz](https://github.com/jtpereyda/boofuzz) ⭐ 2,358 | 🐛 101 | 🌐 Python | 📅 2026-08-06 - Actively maintained network protocol fuzzer and the spiritual successor to Sulley, with session management, target monitoring, and protocol graph support.
...
* Java
  * [JADX](https://github.com/skylot/jadx) ⭐ 50,472 | 🐛 448 | 🌐 Java | 📅 2026-09-12 - Dex to Java decompiler.
  * [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,201 | 🐛 248 | 🌐 Java | 📅 2024-07-08 - Java decompiler.
* .NET
  * [ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,070 | 🐛 176 | 🌐 C# | 📅 2026-09-15 - .NET Decompiler with support for PDB generation, ReadyToRun, Metadata (\&more) - cross-platform!
  * [dnSpy](https://github.com/dnSpyEx/dnSpy) ⭐ 11,073 | 🐛 146 | 🌐 C# | 📅 2026-08-25 - .NET debugger and assembly editor.
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 39,009 | 🐛 605 | 🌐 Ruby | 📅 2026-09-15 - Open source penetration testing framework (BSD licensed) maintained by Rapid7, with modules for exploiting vulnerabilities, scanning, and post-exploitation across embedded Linux and IoT targets.
...
* [IoTGoat](https://github.com/OWASP/IoTGoat) ⭐ 933 | 🐛 2 | 🌐 C | 📅 2025-10-05 - OWASP intentionally insecure firmware for Raspberry Pi and x86 platforms, providing hands-on practice for the OWASP IoT Top 10 vulnerabilities.
...
* [RT-Thread Security](https://github.com/RT-Thread/rt-thread/security) ⭐ 12,219 | 🐛 489 | 🌐 C | 📅 2026-09-15 - Security resources and vulnerability reporting for RT-Thread IoT OS.
...
* [Intel SGX SDK](https://github.com/intel/confidential-computing.sgx) ⭐ 1,454 | 🐛 130 | 🌐 C++ | 📅 2026-08-13 - Open-source Linux SDK and Platform Software for Intel Software Guard Extensions, providing the build/install toolchain for developing and deploying hardware-based memory enclave applications.
...
* [tpm2-tss](https://github.com/tpm2-software/tpm2-tss) ⭐ 901 | 🐛 144 | 🌐 C | 📅 2026-09-09 - Reference implementation of the TCG TPM2 Software Stack (TSS2), providing the APIs for key management and attestation.
* [Caliptra](https://github.com/chipsalliance/Caliptra) ⭐ 473 | 🐛 137 | 📅 2026-09-09 - Apache-2.0 silicon root of trust block for datacenter CPUs, GPUs, and DPUs providing DICE identity, measured boot, and attestation; maintained under CHIPS Alliance, with ML-DSA post-quantum signing added in 2.x.
...
* [fwupd](https://github.com/fwupd/fwupd) ⭐ 4,158 | 🐛 107 | 🌐 C | 📅 2026-09-15 - System daemon that applies signed firmware updates to peripherals and embedded Linux devices, pulling vendor metadata and payloads from the LVFS and staging updates that must run at boot.
...
* [WHAD Framework](https://github.com/whad-team/whad-client) ⭐ 331 | 🐛 73 | 🌐 Python | 📅 2026-06-18 - Hardware-agnostic multi-protocol wireless security framework (BLE, Zigbee, Enhanced ShockBurst, ANT) using a cheap nRF52840 dongle as a universal attack radio; foundation for Quarkslab's BLE GATT fuzzer. DEF CON 32 (2024).
...
* [Rayhunter](https://github.com/EFForg/rayhunter) ⭐ 5,827 | 🐛 100 | 🌐 Rust | 📅 2026-09-15 - EFF's open source Rust tool that runs on a cheap mobile hotspot to detect cell-site simulators (IMSI catchers/Stingrays) by monitoring signaling traffic for suspicious behavior like forced 2G downgrades.
* [Open5GS](https://github.com/open5gs/open5gs) ⭐ 2,717 | 🐛 298 | 🌐 C | 📅 2026-09-14 - Open-source 5G core and 4G EPC, used to stand up a controlled network for baseband and cellular protocol testing.
...
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 884 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - Full-system emulation platform for Samsung (Shannon) and MediaTek cellular baseband firmware with AFL++ fuzzing integration, a task-injection ModKit, and dynamic debugging support. Found 7 pre-authentication memory corruptions. NDSS 2022.
...
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,663 | 🐛 14 | 🌐 Shell | 📅 2026-09-15 - Efficient malware analysis framework for embedded firmware with scanning and reporting.
* [Firmware Analysis Toolkit](https://github.com/attify/firmware-analysis-toolkit) ⭐ 1,600 | 🐛 51 | 🌐 Rust | 📅 2026-09-08 - Automated tool for firmware emulation and vulnerability discovery.
...
* [FwHunt](https://github.com/binarly-io/fwhunt-scan) ⭐ 244 | 🐛 0 | 🌐 Python | 📅 2025-05-02 - Scanner from Binarly that checks UEFI modules and whole firmware images against YAML rules describing known-vulnerable and backdoored components, built on Rizin and usable as a library.

### Emulation Tools

* [Unicorn Engine](https://github.com/unicorn-engine/unicorn) ⭐ 9,341 | 🐛 216 | 🌐 C | 📅 2026-08-28 - A lightweight multi-architecture CPU emulator framework providing pure CPU emulation for ARM, MIPS, x86, RISC-V, and more.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,099 | 🐛 110 | 🌐 Python | 📅 2026-09-13 - An advanced binary emulation framework supporting cross-platform OS-level emulation for Windows, Linux, Android, BSD, UEFI, and multiple architectures.
...
* [FirmAE](https://github.com/pr0v3rbs/FirmAE) ⭐ 933 | 🐛 49 | 🌐 Python | 📅 2026-06-24 - An automated framework for emulation and vulnerability analysis of IoT firmware with an 79% success rate using arbitration techniques.
...
* [LUNA](https://github.com/greatscottgadgets/luna) ⭐ 1,138 | 🐛 33 | 🌐 Python | 📅 2026-08-19 - FPGA-based USB analysis and development platform from Great Scott Gadgets, enabling USB sniffing, protocol fuzzing, and custom USB peripheral development via Amaranth HDL.
...
* [ChipWhisperer](https://github.com/newaetech/chipwhisperer) ⭐ 1,572 | 🐛 48 | 🌐 C | 📅 2026-08-31 - An open-source toolchain for side-channel power analysis and fault injection attacks with complete hardware and software stack.
...
* [libnfc](https://github.com/nfc-tools/libnfc) ⭐ 1,988 | 🐛 120 | 🌐 C | 📅 2025-03-05 - Platform-independent NFC library covering ISO14443-A/B, FeliCa, and MIFARE, and the foundation most other NFC tooling builds on.
...
* [rtl\_433](https://github.com/merbanan/rtl_433) ⭐ 7,808 | 🐛 91 | 🌐 C | 📅 2026-09-14 - Decoder for over 250 ISM-band device protocols covering sensors, utility meters, TPMS, and remotes, built on cheap RTL-SDR hardware.
* [Proxmark3](https://github.com/RfidResearchGroup/proxmark3) ⭐ 6,059 | 🐛 38 | 🌐 C | 📅 2026-09-15 - Open-source RFID research platform for low-level interaction, analysis, and testing across a wide range of LF and HF tags and systems.
* [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) ⭐ 3,013 | 🐛 113 | 🌐 C | 📅 2026-09-11 - Pocket friendly powerful LF and HF emulation & manipulation tool which is based on the open-source project ChameleonMini.
...
* [SigDigger](https://github.com/BatchDrake/SigDigger) ⭐ 2,892 | 🐛 74 | 🌐 C++ | 📅 2026-02-11 - Real-time signal analyser with FSK, PSK, and ASK demodulation and no GNU Radio dependency, aimed at characterising unknown transmissions.
...
* [ESP32 Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,365 | 🐛 327 | 🌐 C++ | 📅 2026-09-15 - A suite of WiFi/Bluetooth offensive and defensive tools for the ESP32.
...
* [HardwareAllTheThings](https://github.com/swisskyrepo/HardwareAllTheThings) ⭐ 956 | 🐛 0 | 🌐 HTML | 📅 2026-08-09 - Actively maintained hardware and IoT pentesting wiki by swisskyrepo covering fault injection, JTAG/SWD/UART exploitation, firmware dumping, side-channel attacks, and RF attacks with practical tooling references.
...
* Domain Specific
  * Automotive
    * [CANbus](https://github.com/iDoka/awesome-canbus) ⭐ 3,466 | 🐛 6 | 📅 2026-08-07 - CAN bus tooling, adapters, protocol documentation, and reverse engineering resources.
    * [CAN IDs](https://github.com/iDoka/awesome-automotive-can-id) ⭐ 983 | 🐛 0 | 📅 2026-08-12 - Catalogue of decoded CAN bus identifiers and message formats across vehicle makes and models.
    * [Awesome Automotive Security](https://github.com/hexsecs/awesome-automotive-security) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Vehicle security research covering CAN, ECUs, telematics, and automotive standards.
* Embedded
  * [General Embedded](https://github.com/nhivp/Awesome-Embedded) ⭐ 9,115 | 🐛 4 | 📅 2026-09-06 - Embedded development resources: RTOSes, toolchains, libraries, and hardware platforms.
  * [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security) ⭐ 2,444 | 🐛 2 | 📅 2023-10-17 - Firmware analysis, emulation, and IoT security research, maintained by Fraunhofer FKIE.
* General Security
  * [OSINT](https://github.com/jivoi/awesome-osint) ⭐ 29,500 | 🐛 17 | 📅 2026-09-09 - Open source intelligence tooling for reconnaissance across people, infrastructure, and internet-exposed devices.
  * [Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,069 | 🐛 73 | 📅 2024-06-02 - Broad collection of offensive security tools, courses, and reference material.
  * [Security](https://github.com/sbilly/awesome-security) ⭐ 14,859 | 🐛 330 | 📅 2026-01-11 - General-purpose security resources spanning network, host, web, and cryptography.
  * [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,195 | 🐛 25 | 📅 2024-06-07 - Static and dynamic malware analysis tools, sandboxes, and sample sources.
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,848 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 - CTF frameworks, practice platforms, wargames, and write-up archives.
  * [Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,563 | 🐛 25 | 🌐 Python | 📅 2026-06-01 - Deception tooling and honeynets spanning network, application, and industrial protocols.
  * [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,691 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - Android reverse engineering, exploitation, and mobile application security tooling.
  * [Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,388 | 🐛 82 | 📅 2026-07-15 - Digital forensics and incident response tooling, playbooks, and training material.
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,057 | 🐛 41 | 🌐 PHP | 📅 2025-02-22 - Secure development practices, code analysis, and application security testing.
  * [Fuzzing](https://github.com/cpuu/awesome-fuzzing) ⭐ 994 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Fuzzers, harnesses, corpora, and research on automated test generation.
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,249 | 🐛 106 | 📅 2026-09-02 - The root Awesome list, indexing curated lists across every topic.
  * [lists](https://github.com/jnv/lists) ⭐ 11,483 | 🐛 27 | 📅 2026-03-23 - Index of curated lists of lists, broader in scope than Awesome itself.
