...
[![Validate Markdown](https://github.com/hexsecs/awesome-embedded-security/workflows/Validate%20Markdown/badge.svg)](https://github.com/hexsecs/awesome-embedded-security/actions/workflows/markdown-lint.yml) ⭐ 55 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-29
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,249 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images.
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,541 | 🐛 31 | 🌐 C++ | 📅 2026-08-20 - Library to Instrument Executable Formats: parse, modify, and abstract ELF, PE, Mach-O, DEX, and OAT binaries found in firmware images.
* [FLARE-FLOSS](https://github.com/mandiant/flare-floss) ⭐ 4,125 | 🐛 120 | 🌐 Python | 📅 2026-08-21 - FLARE Obfuscated String Solver that automatically extracts obfuscated, encoded, and stack strings from binaries for rapid firmware triage.
* [unblob](https://github.com/onekey-sec/unblob) ⭐ 2,542 | 🐛 37 | 🌐 Python | 📅 2026-08-21 - Fast, accurate firmware extraction engine from ONEKEY supporting 100+ archive, compression, and filesystem formats with fewer false positives than Binwalk. Presented at DEF CON 30.
* [checksec](https://github.com/slimm609/checksec.sh) ⭐ 2,366 | 🐛 3 | 🌐 Go | 📅 2026-08-04 - Shell script to check binary security hardening flags (NX, PIE, RELRO, stack canary, ASLR) on ELF executables extracted from firmware.
* [OFRAK](https://github.com/redballoonsecurity/ofrak) ⭐ 2,066 | 🐛 154 | 🌐 Python | 📅 2026-08-17 - Binary analysis and modification platform that combines the ability to unpack, analyze, modify, and repack binaries.
* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,349 | 🐛 29 | 🌐 Rust | 📅 2026-08-20 - Binary analysis tool that checks ELF binaries for violations of Common Weakness Enumerations (CWEs) using abstract interpretation, with cross-architecture support.
* [firmwalker](https://github.com/craigz28/firmwalker) ⭐ 1,222 | 🐛 5 | 🌐 Shell | 📅 2023-08-29 - Searches extracted firmware filesystems for interesting files, credentials, configuration, and known-vulnerable components.
* [VulHunt](https://github.com/vulhunt-re/vulhunt) ⭐ 878 | 🐛 2 | 🌐 C++ | 📅 2026-08-12 - Lua-rule-based vulnerability detection framework from Binarly's research team that operates across disassembly, IR, and decompiled code simultaneously, with dedicated UEFI module scanning support.
* [argXtract](https://github.com/projectbtle/argXtract) ⚠️ Archived - Statically extracts arguments to SVC calls and HAL functions from stripped ARM Cortex-M BLE firmware without symbol tables, enabling security audits of Nordic and similar binaries. ACSAC 2021.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,021 | 🐛 726 | 🌐 Python | 📅 2026-08-21 - Platform-agnostic binary analysis framework. Brought to you by the Computer Security Lab at UC Santa Barbara, SEFCOM at Arizona State University, their associated CTF team, Shellphish, the open source community, and @rhelmot.
* [Capstone](https://github.com/capstone-engine/capstone) ⭐ 8,965 | 🐛 366 | 🌐 C | 📅 2026-08-13 - Lightweight multi-platform, multi-architecture disassembly framework. Their target is to make Capstone the ultimate disassembly engine for binary analysis and reversing in the security community.
* [RetDec](https://github.com/avast/retdec) ⭐ 8,606 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - Retargetable machine-code decompiler from Avast supporting ARM, MIPS, x86, and other architectures common in embedded firmware.
* [Keystone](https://github.com/keystone-engine/keystone) ⭐ 2,621 | 🐛 243 | 🌐 C++ | 📅 2026-07-18 - A lightweight multi-architecture assembler framework that complements Capstone.
...
* [Angr Management](https://github.com/angr/angr-management) ⭐ 1,172 | 🐛 245 | 🌐 Python | 📅 2026-08-21 - Multi-architecture binary analysis toolkit, with the capability to perform dynamic symbolic execution (like Mayhem, KLEE, etc.) and various static analyses on binaries. If you'd like to learn how to use it, you're in the right place!
* [Vivisect](https://github.com/vivisect/vivisect) ⭐ 999 | 🐛 118 | 🌐 Python | 📅 2026-08-20 - A combined disassembler/static analysis/symbolic execution/debugger framework.
...
* [Open OCD](https://github.com/openocd-org/openocd/) ⭐ 2,300 | 🐛 3 | 🌐 C | 📅 2026-08-18 - Provides on-chip programming and debugging support with a layered architecture of JTAG interface and TAP support.
...
* [MCUboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,038 | 🐛 104 | 🌐 C | 📅 2026-08-13 - Secure bootloader for 32-bit microcontrollers supporting signed images, rollback protection, and measured boot flows.
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 521 | 🐛 12 | 🌐 C | 📅 2026-08-21 - Portable secure bootloader for 32-bit MCUs using wolfCrypt for image signature verification (Ed25519, ECC, RSA, post-quantum LMS/XMSS), with delta updates, encrypted images, and explicit voltage-glitch countermeasures.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,771 | 🐛 406 | 🌐 Go | 📅 2026-08-20 - Vulnerability scanner that consumes SBOMs to identify known CVEs in firmware dependencies.
* [Syft](https://github.com/anchore/syft) ⭐ 9,440 | 🐛 624 | 🌐 Go | 📅 2026-08-20 - SBOM generator for filesystems and artifacts, useful for firmware package/component inventories.
* [Sigstore Cosign](https://github.com/sigstore/cosign) ⭐ 6,226 | 🐛 162 | 🌐 Go | 📅 2026-08-19 - Tooling for keyless signing and verification of firmware/container artifacts in CI/CD pipelines.
* [CVE Binary Tool](https://github.com/ossf/cve-bin-tool) ⭐ 1,747 | 🐛 231 | 🌐 Python | 📅 2026-08-19 - OpenSSF tool that scans binaries directly for 350+ known-vulnerable open source components (OpenSSL, libpng, BusyBox, and more), without requiring a pre-built SBOM; can also generate one from the scan.
...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,729 | 🐛 23 | 🌐 C | 📅 2026-08-21 - A coverage-guided fuzzer with enhanced mutations, QEMU and Unicorn emulation modes, and custom power schedules.
* [honggfuzz](https://github.com/google/honggfuzz) ⭐ 3,374 | 🐛 30 | 🌐 C | 📅 2026-06-19 - A feedback-driven evolutionary fuzzer supporting hardware-based coverage (Intel BTS/PT) and persistent mode for extreme speed.
...
* .NET
  * [ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,906 | 🐛 188 | 🌐 C# | 📅 2026-08-21 - .NET Decompiler with support for PDB generation, ReadyToRun, Metadata (\&more) - cross-platform!
  * [dnSpy](https://github.com/dnSpyEx/dnSpy) ⭐ 10,937 | 🐛 149 | 🌐 C# | 📅 2026-07-20 - .NET debugger and assembly editor.
  * [de4dot](https://github.com/de4dot/de4dot) ⚠️ Archived - .NET deobfuscator.
* Java
  * [JADX](https://github.com/skylot/jadx) ⭐ 50,150 | 🐛 442 | 🌐 Java | 📅 2026-08-19 - Dex to Java decompiler.
  * [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,176 | 🐛 248 | 🌐 Java | 📅 2024-07-08 - Java decompiler.

### Security Auditing Frameworks

* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,835 | 🐛 610 | 🌐 Ruby | 📅 2026-08-21 - Open source penetration testing framework (BSD licensed) maintained by Rapid7, with modules for exploiting vulnerabilities, scanning, and post-exploitation across embedded Linux and IoT targets.
* [kernel-hardening-checker](https://github.com/a13xp0p0v/kernel-hardening-checker) ⭐ 2,121 | 🐛 13 | 🌐 Python | 📅 2026-08-16 - Audits Linux kernel Kconfig options and boot parameters against KSPP, CLIP OS, and STIG hardening recommendations; supports ARM, ARM64, x86, and RISC-V. Works in Yocto/OpenEmbedded pipelines.
* [IoTGoat](https://github.com/OWASP/IoTGoat) ⭐ 918 | 🐛 2 | 🌐 C | 📅 2025-10-05 - OWASP intentionally insecure firmware for Raspberry Pi and x86 platforms, providing hands-on practice for the OWASP IoT Top 10 vulnerabilities.
...
* [RT-Thread Security](https://github.com/RT-Thread/rt-thread/security) ⭐ 12,161 | 🐛 479 | 🌐 C | 📅 2026-08-21 - Security resources and vulnerability reporting for RT-Thread IoT OS.
...
* [Intel SGX SDK](https://github.com/intel/linux-sgx) ⭐ 1,449 | 🐛 138 | 🌐 C++ | 📅 2026-08-13 - Open-source Linux SDK and Platform Software for Intel Software Guard Extensions, providing the build/install toolchain for developing and deploying hardware-based memory enclave applications.
...
* [TPM 2.0 TS](https://github.com/tpm2-software/tpm2-tss) ⭐ 896 | 🐛 147 | 🌐 C | 📅 2026-08-13 - TCG Software Stack for TPM 2.0 providing API for key management and attestation.
...
* [KillerBee](https://github.com/riverloopsec/killerbee) ⭐ 847 | 🐛 31 | 🌐 C | 📅 2023-09-12 - IEEE 802.15.4/ZigBee security research framework for capturing, injecting, and analyzing ZigBee network traffic using compatible radio hardware.
...
* [GATTacker](https://github.com/securing/gattacker) ⭐ 844 | 🐛 18 | 🌐 JavaScript | 📅 2022-01-31 - BLE MITM tool for intercepting and relaying GATT profiles to test BLE device authentication and data integrity.
...
* [WHAD Framework](https://github.com/whad-team/whad-client) ⭐ 328 | 🐛 73 | 🌐 Python | 📅 2026-06-18 - Hardware-agnostic multi-protocol wireless security framework (BLE, Zigbee, Enhanced ShockBurst, ANT) using a cheap nRF52840 dongle as a universal attack radio; foundation for Quarkslab's BLE GATT fuzzer. DEF CON 32 (2024).
...
* [Rayhunter](https://github.com/EFForg/rayhunter) ⭐ 5,610 | 🐛 95 | 🌐 Rust | 📅 2026-08-20 - EFF's open source Rust tool that runs on a cheap mobile hotspot to detect cell-site simulators (IMSI catchers/Stingrays) by monitoring signaling traffic for suspicious behavior like forced 2G downgrades.
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 876 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - Full-system emulation platform for Samsung (Shannon) and MediaTek cellular baseband firmware with AFL++ fuzzing integration, a task-injection ModKit, and dynamic debugging support. Found 7 pre-authentication memory corruptions. NDSS 2022.
...
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,599 | 🐛 27 | 🌐 Shell | 📅 2026-08-18 - Efficient malware analysis framework for embedded firmware with scanning and reporting.
...
* [Unicorn Engine](https://github.com/unicorn-engine/unicorn) ⭐ 9,251 | 🐛 214 | 🌐 C | 📅 2026-07-30 - A lightweight multi-architecture CPU emulator framework providing pure CPU emulation for ARM, MIPS, x86, RISC-V, and more.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,063 | 🐛 123 | 🌐 Python | 📅 2026-07-22 - An advanced binary emulation framework supporting cross-platform OS-level emulation for Windows, Linux, Android, BSD, UEFI, and multiple architectures.
* [PANDA](https://github.com/panda-re/panda) ⭐ 2,775 | 🐛 97 | 🌐 C | 📅 2026-07-29 - Platform for Architecture-Neutral Dynamic Analysis with record/replay functionality and LLVM IR translation for whole-system analysis.
* [Firmadyne](https://github.com/firmadyne/firmadyne) ⭐ 2,099 | 🐛 107 | 🌐 Shell | 📅 2024-07-21 - Automated system for emulating and analyzing Linux-based embedded firmware; extracts and boots firmware images in QEMU to enable dynamic vulnerability discovery.
* [FirmAE](https://github.com/pr0v3rbs/FirmAE) ⭐ 915 | 🐛 49 | 🌐 Python | 📅 2026-06-24 - An automated framework for emulation and vulnerability analysis of IoT firmware with an 79% success rate using arbitration techniques.
* [Avatar2](https://github.com/avatartwo/avatar2) ⭐ 575 | 🐛 27 | 🌐 Python | 📅 2025-03-31 - Dynamic analysis orchestration framework for binary firmware that coordinates execution across emulators (QEMU, Unicorn) and real hardware targets.
...
* [Icicle](https://github.com/icicle-emu/icicle-emu) ⭐ 308 | 🐛 14 | 🌐 Rust | 📅 2026-08-08 - Rust-based grey-box fuzzer with architecture-agnostic coverage instrumentation, notable for supporting **MSP430 and RISC-V** where AFL++ QEMU mode has no coverage. ISSTA 2023.
...
* [Tiguard](https://github.com/tigard-tools/tigard) ⭐ 858 | 🐛 2 | 📅 2026-05-29 - An FTDI FT2232H-based multi-protocol tool for hardware hacking.
...
* [LUNA](https://github.com/greatscottgadgets/luna) ⭐ 1,132 | 🐛 32 | 🌐 Python | 📅 2026-08-19 - FPGA-based USB analysis and development platform from Great Scott Gadgets, enabling USB sniffing, protocol fuzzing, and custom USB peripheral development via Amaranth HDL.
* [JTAGenum](https://github.com/cyphunk/JTAGenum) ⭐ 800 | 🐛 13 | 🌐 C++ | 📅 2023-10-30 - Enumerates JTAG pinouts on unknown boards by brute-force testing candidate pin mappings.
* [JTAGulator](https://github.com/grandideastudio/jtagulator) ⭐ 800 | 🐛 3 | 🌐 Propeller Spin | 📅 2025-07-29 - Automates discovery of JTAG, SWD, and UART debug interfaces on unknown PCBs by brute-forcing pin combinations, with sigrok-compatible logic analyzer mode and direct OpenOCD integration for post-discovery exploitation.
...
* [CHIPSEC](https://github.com/chipsec/chipsec) ⭐ 3,294 | 🐛 55 | 🌐 Python | 📅 2026-08-21 - Platform security assessment framework with firmware and chipset checks relevant to offline dump triage.
...
* [SNANDer](https://github.com/McMCCRU/SNANDer) ⭐ 381 | 🐛 19 | 🌐 C | 📅 2026-05-20 - CLI programmer for SPI NOR/NAND flash and I2C EEPROMs using the ubiquitous $3 CH341A USB chip, extending it with NAND support beyond what proprietary software provides — the go-to for quick firmware dumps from IoT hardware.
...
* [ChipWhisperer](https://github.com/newaetech/chipwhisperer) ⭐ 1,556 | 🐛 50 | 🌐 C | 📅 2026-08-21 - An open-source toolchain for side-channel power analysis and fault injection attacks with complete hardware and software stack.
...
* [PicoEMP](https://github.com/newaetech/chipshouter-picoemp) ⭐ 755 | 🐛 23 | 🌐 C | 📅 2024-08-28 - NewAE's open hardware EMFI tool built on a Raspberry Pi Pico and photographic-flash transformer circuit; the community standard entry-level electromagnetic fault injection platform.
* [PicoGlitcher](https://github.com/MKesenheimer/fault-injection-library) ⭐ 204 | 🐛 7 | 🌐 Python | 📅 2026-07-29 - RP2040/RP2350-based voltage glitching platform with 66A crowbar, sub-10ns pulse resolution via PIO sampling, and a high-level Python (`findus`) API for scripting attack campaigns. Validated by SySS Research.
* [Faulty Cat](https://github.com/ElectronicCats/faultycat) ⭐ 152 | 🐛 3 | 📅 2026-07-06 - Low-cost open hardware EMFI tool from Electronic Cats built on an RP2040, offering both electromagnetic and crowbar voltage-glitching fault injection with single-shot and parameter-sweep campaign modes.
...
* [Proxmark3](https://github.com/RfidResearchGroup/proxmark3) ⭐ 5,972 | 🐛 72 | 🌐 C | 📅 2026-08-21 - Open-source RFID research platform for low-level interaction, analysis, and testing across a wide range of LF and HF tags and systems.
* [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) ⭐ 2,936 | 🐛 117 | 🌐 C | 📅 2026-08-10 - Pocket friendly powerful LF and HF emulation & manipulation tool which is based on the open-source project ChameleonMini.
* [Awesome Flipper Zero](https://github.com/RogueMaster/awesome-flipperzero-withModules) ⭐ 2,006 | 🐛 0 | 🌐 C | 📅 2026-08-20 - A collection of Awesome resources for the Flipper Zero device.
...
* [ESP32Maurauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,052 | 🐛 325 | 🌐 C++ | 📅 2026-08-21 - A suite of WiFi/Bluetooth offensive and defensive tools for the ESP32.

## Further Learning and Training

* [HardwareAllTheThings](https://github.com/swisskyrepo/HardwareAllTheThings) ⭐ 931 | 🐛 0 | 🌐 HTML | 📅 2026-08-09 - Actively maintained hardware and IoT pentesting wiki by swisskyrepo covering fault injection, JTAG/SWD/UART exploitation, firmware dumping, side-channel attacks, and RF attacks with practical tooling references.
...
* [Awesome OSINT](https://github.com/jivoi/awesome-osint) ⭐ 28,220 | 🐛 4 | 📅 2026-08-20
...
* General Security
  ...
  * [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,627 | 🐛 1 | 🌐 Makefile | 📅 2026-08-19
  ...
  * [Fuzzing](https://github.com/cpuu/awesome-fuzzing) ⭐ 987 | 🐛 1 | 📅 2026-07-09
* Embedded
  * [General Embedded](https://github.com/nhivp/Awesome-Embedded) ⭐ 9,013 | 🐛 3 | 📅 2026-08-12
  * [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security) ⭐ 2,425 | 🐛 2 | 📅 2023-10-17
* Domain Specific
  * Automotive
    * [CANbus](https://github.com/iDoka/awesome-canbus) ⭐ 3,424 | 🐛 6 | 📅 2026-08-07
    * [CANb IDs](https://github.com/iDoka/awesome-automotive-can-id) ⭐ 976 | 🐛 0 | 📅 2026-08-12
    * [Awesome Automotive Security](https://github.com/hexsecs/awesome-automotive-security) ⭐ 9 | 🐛 0 | 📅 2026-05-16
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,464 | 🐛 105 | 📅 2026-08-18
